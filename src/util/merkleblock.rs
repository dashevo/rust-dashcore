...
//!
//! ```rust
//! use dash::hash_types::Txid;
//! use dash::hashes::hex::FromHex;
//! use dash::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = dash::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl PartialMerkleTree {
    ...
    /// use dash::hash_types::Txid;
    /// use dash::hashes::hex::FromHex;
    /// use dash::util::merkleblock::PartialMerkleTree;
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
...
impl MerkleBlock {
    ...
    /// let block: Block = dash::consensus::deserialize(&block_bytes).unwrap();
    ///
