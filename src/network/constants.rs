...
//!
//! ```rust
//! use dash::network::constants::Network;
//! use dash::consensus::encode::serialize;
//!
...
impl Network {
    ...
    /// use dash::network::constants::Network;
    ///
    /// assert_eq!(Some(Network::Dash), Network::from_magic(0xD4B4BEF9));
    /// assert_eq!(None, Network::from_magic(0xFFFFFFFF));
    /// ```
    pub fn from_magic(magic: u32) -> Option<Network> {
        // Note: any new entries here must be added to `magic` below
        match magic {
            0xD4B4BEF9 => Some(Network::Dash),
...
mod tests {
    ...
    #[test]
    fn serialize_test() {
        assert_eq!(serialize(&Network::Dash.magic()), &[0xd4, 0xb4, 0xbe, 0xf9]);
        ...
        assert_eq!(deserialize(&[0xd4, 0xb4, 0xbe, 0xf9]).ok(), Some(Network::Dash.magic()));
